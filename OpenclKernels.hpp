...
using qr_decomposition_kernel_type = cl::KernelFunctor<const int, const int, const int, cl::Buffer&, cl::Buffer&, cl::Buffer&, cl::Buffer&, cl::LocalSpaceArg>;
...
public:
    ...
    static void qr_decomposition(int nbrows, int nbcols, int block_size, cl::Buffer& sh_ptrs, cl::Buffer& sh_inds, cl::Buffer& sh_vals, cl::Buffer& rv_mat);
};
